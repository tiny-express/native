...
//    char *result = sha1((unsigned char*)target);
//    return result;
//}
...
//    char *result = sha1((unsigned char*)target.c_str());
//    return result;
//}
...
//    char *result = sha1((unsigned char*)string_from_int(target));
//    return result;
//}
...
//    char *result = sha1((unsigned char*)string_from_long(target));
//    return result;
//}
...
//    char *result = sha1((unsigned char*)string_from_double(target));
//    return result;
//}
